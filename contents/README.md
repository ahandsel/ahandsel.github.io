...
VitePress site source for [Genji Fujimori's portfolio](https://ahandsel.github.io). This folder holds all bilingual page content, the VitePress config, and the custom theme.
